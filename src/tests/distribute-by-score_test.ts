...
import { DistributeByScoreReq } from "../x/trust/types/distribute-by-score-req";
...
async function DistributeByScore() {
    // TODO: amount をstringに変更する
    const params: DistributeByScoreReq = {
    ...
    try {
        let result = await Trust.distributeByScore(sdk, params)
