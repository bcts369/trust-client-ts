...
import { DistributeByEvaluationReq } from "../x/trust/types/distribute-by-evaluation-req"
...
async function distributeByEvaluation() {
    // TODO: amount をstringに変更する
    const params: DistributeByEvaluationReq = {
    ...
    try {
        let result = await Trust.distributeByEvaluation(sdk, params)
